...
datos.csv tiene toda la información obtenida en cada frame. Posiciones de las etiquetas, distancias entre puntos de la trayectoria, distancia a la trayectoria desde la etiqueta trasera, si se consideró derrape. Tambien sobre la carrera, el pwm aplicado, si se curzó la meta o el sector.
